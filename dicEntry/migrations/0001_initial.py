    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(blank=True, max_length=255, null=True, verbose_name='条目内容')),
        ...
        migrations.AddField(
            model_name='entry',
            name='entry',
            field=models.ManyToManyField(related_name='related_to', through='dicEntry.Relationship', to='dicEntry.Entry'),
        ),
        migrations.AddField(
            model_name='entry',
            name='title',
